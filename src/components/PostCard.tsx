...
const Chip = ({ label }: { label: string }) => (
  <span className="px-2 py-1 rounded-full text-xs font-medium bg-gradient-subtle text-primary border border-primary/20 hover:bg-primary/10 transition-all duration-200 cursor-pointer hover:scale-105">
    {label}
  </span>
);
        ...
        <div className="relative">
          ...
          {followState !== 'hidden' && (
            <button
              ...
              className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-white border border-gray-200 flex items-center justify-center shadow-md hover:scale-110 transition-all duration-200"
